...
CREATE TABLE [T_QREST_SITE_POLL_CONFIG_DTL] (
    ...
    CONSTRAINT [FK_T_SITE_POLL_CONFIG_DTL_P] FOREIGN KEY ([POLL_CONFIG_IDX]) REFERENCES [T_QREST_SITE_POLL_CONFIG] ([POLL_CONFIG_IDX]),
    CONSTRAINT [FK_T_SITE_POLL_CONFIG_DTL_M] FOREIGN KEY ([MONITOR_IDX]) REFERENCES [T_QREST_MONITORS] ([MONITOR_IDX]),
);
