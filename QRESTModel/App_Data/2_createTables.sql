...
drop table if EXISTS [T_QREST_ASSESS_DOCS];
drop table if EXISTS [T_QREST_DATA_HOURLY_LOG];
drop table if EXISTS [T_QREST_DATA_HOURLY];
...
drop table IF EXISTS [T_QREST_REF_USER_STATUS];
drop table IF EXISTS [T_QREST_REF_ACCESS_LEVEL];
...
GO
--ALTER TABLE T_QREST_SITES ADD [AIRNOW_USR] varchar(50);
--ALTER TABLE T_QREST_SITES ADD [AIRNOW_PWD] varchar(50);
--ALTER TABLE T_QREST_SITES ADD [AIRNOW_ORG] varchar(3);
--ALTER TABLE T_QREST_SITES ADD [AIRNOW_SITE] varchar(10);
...
--ALTER TABLE T_QREST_SITE_NOTIFY DROP CONSTRAINT [FK_T_QREST_SITE_NOTIFY_S];
--ALTER TABLE T_QREST_SITE_NOTIFY ADD CONSTRAINT [FK_T_QREST_SITE_NOTIFY_S] FOREIGN KEY ([SITE_IDX]) REFERENCES [T_QREST_SITES] ([SITE_IDX]) ON DELETE CASCADE;
...
--ALTER TABLE T_QREST_SITE_POLL_CONFIG DROP CONSTRAINT [FK_T_SITE_POLL_CONFIG_S];
--ALTER TABLE T_QREST_SITE_POLL_CONFIG ADD CONSTRAINT [FK_T_SITE_POLL_CONFIG_S] FOREIGN KEY ([SITE_IDX]) REFERENCES [T_QREST_SITES] ([SITE_IDX]) ON DELETE CASCADE;
--ALTER TABLE T_QREST_SITE_POLL_CONFIG ADD [CONFIG_NAME] varchar(20) NULL;
--ALTER TABLE T_QREST_SITE_POLL_CONFIG ADD [TIME_POLL_TYPE] varchar(1);
...
--ALTER TABLE [T_QREST_SITE_POLL_CONFIG_DTL] ADD [ADJUST_FACTOR] float;
GO
...
--ALTER TABLE [T_QREST_DATA_FIVE_MIN] ADD [IMPORT_IDX] [uniqueidentifier] NULL;
...
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [AQS_NULL_CODE] [varchar](2);
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [LVL1_VAL_IND] [bit] NULL;
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [LVL1_VAL_USERIDX] nvarchar(128) NULL;
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [LVL1_VAL_DT] [datetime2](0) NULL;
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [LVL2_VAL_IND] [bit] NULL;
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [LVL2_VAL_USERIDX] nvarchar(128) NULL;
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [LVL2_VAL_DT] [datetime2](0) NULL;
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [NOTES] varchar(100) NULL;
--ALTER TABLE [T_QREST_DATA_HOURLY] ADD [IMPORT_IDX] [uniqueidentifier] NULL;
