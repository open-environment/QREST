...
namespace QRESTModel.DAL
{
    ...
    public partial class QRESTEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<System.DateTime>> SP_LATEST_POLLED_DATE(Nullable<System.Guid> siteid, string durcode, string timetype)
        {
            var siteidParameter = siteid.HasValue ?
                new ObjectParameter("siteid", siteid) :
                new ObjectParameter("siteid", typeof(System.Guid));
    
            var durcodeParameter = durcode != null ?
                new ObjectParameter("durcode", durcode) :
                new ObjectParameter("durcode", typeof(string));
    
            var timetypeParameter = timetype != null ?
                new ObjectParameter("timetype", timetype) :
                new ObjectParameter("timetype", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<System.DateTime>>("SP_LATEST_POLLED_DATE", siteidParameter, durcodeParameter, timetypeParameter);
        }
        ...
        public virtual ObjectResult<SP_DAILY_AVG_Result> SP_DAILY_AVG(Nullable<System.DateTime> sDate, Nullable<System.DateTime> eDate, Nullable<System.Guid> monid)
        {
            var sDateParameter = sDate.HasValue ?
                new ObjectParameter("sDate", sDate) :
                new ObjectParameter("sDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_DAILY_AVG_Result>("SP_DAILY_AVG", sDateParameter, eDateParameter, monidParameter);
        }
    
        public virtual int SP_IMPORT_DETECT_DUPES(Nullable<System.Guid> impidx)
        {
            var impidxParameter = impidx.HasValue ?
                new ObjectParameter("impidx", impidx) :
                new ObjectParameter("impidx", typeof(System.Guid));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_IMPORT_DETECT_DUPES", impidxParameter);
        }
