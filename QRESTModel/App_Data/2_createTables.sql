...
CREATE TABLE [dbo].[T_QREST_USERS](
	...
	[FAV_MONITOR_IDX] UNIQUEIDENTIFIER NULL,
...
--alter table [T_QREST_USERS] add 	[FAV_MONITOR_IDX] UNIQUEIDENTIFIER NULL;
...
CREATE TABLE [dbo].[T_QREST_REF_QUAL_DISALLOW](
	[QUAL_CODE] [varchar](2) NOT NULL,
	[PAR_CODE] [varchar](6) NOT NULL,
	[CREATE_USER_IDX] [nvarchar](128) NULL,
	[CREATE_DT] [datetime2](0) NULL,
	[MODIFY_USER_IDX] [nvarchar](128) NULL,
	[MODIFY_DT] [datetime2](0) NULL,
 CONSTRAINT [PK_T_QREST_REF_QUAL_DISALLOW] PRIMARY KEY CLUSTERED ( [QUAL_CODE], [PAR_CODE] ASC )
) ON [PRIMARY]
...
CREATE NONCLUSTERED INDEX IDX_FIVE_MIN__DATA_DTTM ON [dbo].[T_QREST_DATA_FIVE_MIN] ([DATA_DTTM]);
...
CREATE NONCLUSTERED INDEX [nci_wi_T_QREST_DATA_HOURLY_5] ON [dbo].[T_QREST_DATA_HOURLY] ([DATA_DTTM_UTC]) INCLUDE ([MONITOR_IDX]) WITH (ONLINE = ON);  --this is used for monthly global stats
...
CREATE TABLE [dbo].[T_QREST_DATA_IMPORTS](
	...
	[RECALC_IND] bit,
	[REC_COUNT] int,
	[REC_MIN_DATE] datetime2(0),
	[REC_MAX_DATE] datetime2(0),
...
--alter table T_QREST_DATA_IMPORTS add REC_COUNT int NULL;
--alter table T_QREST_DATA_IMPORTS add REC_MIN_DATE datetime2(0) NULL;
--alter table T_QREST_DATA_IMPORTS add REC_MAX_DATE datetime2(0) NULL;
...
alter table [T_QREST_AQS] add STAGE_CNT int null;
alter table [T_QREST_AQS] add LOAD_CNT int null;
